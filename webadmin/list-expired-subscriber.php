...
if(!isset($_SESSION["inte_sess_view_expired_subscriber"])){
...
<?php include("header.php"); ?>
	...
	<div class="rightbodysec">
		<h1>Manage Expired Subscriber </h1>
        ...
        <tr>
		  ...
		  <table width="100%" border="0" class='mGrid'>
            ...
            <?php 
			 ...
			 " where DATE_ADD(date(subscribedatetime), INTERVAL validity DAY) < current_date  $cond $orderby";
