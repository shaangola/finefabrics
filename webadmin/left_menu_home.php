...
<div id="mainleft">
	<div class="inner2">
		<a href="javascript: void(0);">
			<div class="maintablef silverheader">
				<div class="content1"><img src="images/menu/house.png"  width="16" height="16"/></div>
	...
	<?php 
	$sql_menu="select menu_id,menu_name,icon from "._DB_PREFIX."menu where parent_id='0' and ispublish=1 and menu_type=0  order by order_index asc";
	$db_menu->query($sql_menu);
	//var_dump($data_menu=$db_menu->fetchArray());
		...
		<div class="inner2">
			<a href="javascript: void(0);">
				<div class="maintablefdactive silverheader">
					<div class="content1"><img src="images/menu/<?php echo $menu_icon;?>" width="16" height="16" /></div>
			...
			<?php
				...
				?>
					<a href="<?php echo $page_name;?>"><img src="images/menu/<?php echo $submenu_icon;?>" width="16" height="16" />&nbsp;<?php echo $submenu_name;?></a> 
				<?php
				}
				?>
			</div>
